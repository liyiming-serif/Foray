...
turn_rank = ds_map_find_value(cmp,"turn_rank");
...
neutral_speed = scr_interpolate_stat(speed_rank, global.speeds);
brake_speed = scr_interpolate_stat(speed_rank, global.brake_speeds);
boost_speed = scr_interpolate_stat(speed_rank, global.boost_speeds);
base_turn = scr_interpolate_stat(turn_rank, global.turns);
turn_accel = scr_interpolate_stat(turn_accel_rank, global.turn_accels);
roll_speed = scr_interpolate_stat(turn_rank, global.roll_speeds);
roll_duration = scr_interpolate_stat(roll_duration_rank, global.roll_durations);
roll_cooldown = scr_interpolate_stat(roll_cooldown_rank, global.roll_cooldowns);
